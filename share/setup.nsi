...
!define MUI_ICON "../share/pixmaps/wayawolfcoin.ico"
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/wayawolfcoin-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/wayawolfcoind.exe
    SetOutPath $INSTDIR\src
    File /r /x *.exe /x *.o ../src\*.*
    SetOutPath $INSTDIR
    WriteRegStr HKCU "${REGKEY}\Components" Main 1

    # Remove old wxwidgets-based-wayawolfcoin executable and locales:
    #Delete /REBOOTOK $INSTDIR\wayawolfcoin.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\wayawolfcoin-qt.exe
...
Section -un.post UNSEC0001
    ...
    DeleteRegKey HKCR "wayawolfcoin"
