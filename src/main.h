...
#ifndef WAYAWOLFCOIN_MAIN_H
#define WAYAWOLFCOIN_MAIN_H
...
static const int64_t MAX_MONEY = 12000000 * COIN; // 12 million
...
inline unsigned int GetTargetSpacing(int nHeight) {return 180; }
static const int64_t PREMINE_PERIOD = 11;
static const int64_t INITIAL_SUBSIDY = 1006000 * COIN;
static const int64_t LAUNCH_PERIOD = 1440;
static const int64_t LAUNCH_REWARD = 0;
static const int64_t FIRST_HALVING_HEIGHT = 44640;
static const double HALVING_INTERVAL = 175680;
static const double MIN_REWARD = 0.001 * COIN;
static const double INITIAL_REWARD = 6.25 * COIN;
...
public:
    ...
    /** Amount of wayawolfcoins spent by this transaction.
    ...
    /** Amount of wayawolfcoins coming in to this transaction
