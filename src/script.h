...
#ifndef H_WAYAWOLFCOIN_SCRIPT
#define H_WAYAWOLFCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CWayawolfcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Wayawolfcoin always counted CHECKMULTISIGs
