...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        // Parameters
        //
        // If Qt is used, parameters/wayawolfcoin.conf are parsed in qt/wayawolfcoin.cpp's main()
        ...
        {
            // First part of help message is specific to wayawolfcoind / RPC client
...
int main(int argc, char* argv[])
{
    ...
    // Connect wayawolfcoind signal handlers
    noui_connect();
