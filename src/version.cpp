...
// for both wayawolfcoind and wayawolfcoin-qt, to make it harder for attackers to
// target servers or GUI users specifically.
const std::string CLIENT_NAME("canis-lupus");

// Client version number
#define CLIENT_VERSION_SUFFIX   "canis-lupus"
