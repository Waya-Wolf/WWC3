...
std::string HelpMessage()
{
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 9952 or testnet: 8952)") + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 9953 or testnet: 8953)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // requested to kill wayawolfcoin-qt during the last operation. If so, exit.
