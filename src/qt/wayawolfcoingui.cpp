...
WayawolfcoinGUI::WayawolfcoinGUI(QWidget *parent):
    QMainWindow(parent),
    clientModel(0),
    walletModel(0),
    toolbar(0),
...
{
    resize(850+95, 550);
    setWindowTitle(tr("Wayawolfcoin") + " - " + tr("Canis Lupus"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/wayawolfcoin"));
    setWindowIcon(QIcon(":icons/wayawolfcoin"));
#else
    ...
    syncIconMovie = new QMovie(fUseBlackTheme ? ":/icons/notsynced" : ":/icons/notsynced", "png", this);
...
WayawolfcoinGUI::~WayawolfcoinGUI()
{
...
void WayawolfcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Wayawolfcoin address"));
    ...
    blockAction = new QAction(QIcon(fUseBlackTheme ? ":/icons/black/blockbrowser" : ":/icons/blockbrowser"), tr("&Block Browser"), this);
    ...
    aboutAction = new QAction(tr("&About Wayawolfcoin"), this);
    aboutAction->setToolTip(tr("Show information about Wayawolfcoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Wayawolfcoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/wayawolfcoin"), tr("&Show / Hide"), this);
...
void WayawolfcoinGUI::createMenuBar()
{
...
static QWidget* makeToolBarSpacer()
{
    ...
    spacer->setStyleSheet(fUseBlackTheme ? "QWidget { background: rgb(19,60,102); }" : "QWidget { background: none; }");
    return spacer;
}

void WayawolfcoinGUI::createToolBars()
{
    ...
    if (fUseBlackTheme)
    {
        header->setStyleSheet("QWidget { background-color: rgb(19,60,102); background-repeat: no-repeat; background-image: url(:/images/header); background-position: top center; }"); // top background at logo
    }
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/wayawolfcoin_testnet"));
            setWindowIcon(QIcon(":icons/wayawolfcoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/wayawolfcoin_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Wayawolfcoin client") + QString(" ") + tr("[testnet]"));
...
void WayawolfcoinGUI::setWalletModel(WalletModel *walletModel)
{
...
void WayawolfcoinGUI::createTrayIcon()
{
    QMenu *trayIconMenu;
#ifndef Q_OS_MAC
    ...
    trayIcon->setToolTip(tr("Wayawolfcoin client"));
...
#ifndef Q_OS_MAC
void WayawolfcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void WayawolfcoinGUI::optionsClicked()
{
...
void WayawolfcoinGUI::aboutClicked()
{
    AboutDialog dlg;
...
void WayawolfcoinGUI::setNumConnections(int count)
{
    QString icon;
    switch(count)
    {
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Wayawolfcoin network", "", count));
}

void WayawolfcoinGUI::setNumBlocks(int count)
{
...
void WayawolfcoinGUI::message(const QString &title, const QString &message, bool modal, unsigned int style)
{
    QString strTitle = tr("Wayawolfcoin") + " - ";
...
void WayawolfcoinGUI::changeEvent(QEvent *e)
{
...
void WayawolfcoinGUI::closeEvent(QCloseEvent *event)
{
    if(clientModel)
    {
#ifndef Q_OS_MAC // Ignored on Mac
...
void WayawolfcoinGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;
    ...
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        ...
        "Do you want to pay the fee?").arg(WayawolfcoinUnits::formatWithUnit(clientModel->getOptionsModel()->getDisplayUnit(), nFeeRequired));
...
void WayawolfcoinGUI::incomingTransaction(const QModelIndex & parent, int start, int end)
{
        ...
        notificator->notify(Notificator::Information,
                            (amount)<0 ? tr("Sent transaction") :
                              ...
                              tr("Date: %1\n"
                                 ...
                                 "Address: %4\n")
                              .arg(date)
                              .arg(WayawolfcoinUnits::formatWithUnit(walletModel->getOptionsModel()->getDisplayUnit(), amount, true))
                              .arg(type)
                              .arg(address), icon);
    }
}

void WayawolfcoinGUI::gotoOverviewPage()
{
...
void WayawolfcoinGUI::gotoHistoryPage()
{
...
void WayawolfcoinGUI::gotoAddressBookPage()
{
...
void WayawolfcoinGUI::gotoBlockBrowser(QString transactionId)
{
...
void WayawolfcoinGUI::gotoReceiveCoinsPage()
{
...
void WayawolfcoinGUI::gotoSendCoinsPage()
{
...
void WayawolfcoinGUI::gotoSignMessageTab(QString addr)
{
...
void WayawolfcoinGUI::gotoVerifyMessageTab(QString addr)
{
...
void WayawolfcoinGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void WayawolfcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Wayawolfcoin address or malformed URI parameters."));
    }

    event->acceptProposedAction();
}

void WayawolfcoinGUI::handleURI(QString strURI)
{
    // URI has to be valid
...
void WayawolfcoinGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void WayawolfcoinGUI::encryptWallet()
{
    if(!walletModel)
        return;
...
void WayawolfcoinGUI::backupWallet()
{
...
void WayawolfcoinGUI::changePassphrase()
{
...
void WayawolfcoinGUI::unlockWallet()
{
    if(!walletModel)
        return;
...
void WayawolfcoinGUI::lockWallet()
{
    if(!walletModel)
        return;
...
void WayawolfcoinGUI::showNormalIfMinimized(bool fToggleHidden)
{
...
void WayawolfcoinGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void WayawolfcoinGUI::updateWeight()
{
    if (!pwalletMain)
        return;
...
void WayawolfcoinGUI::updateStakingIcon()
{
    updateWeight();
...
void WayawolfcoinGUI::stakeReportClicked()
{
...
void WayawolfcoinGUI::detectShutdown()
{
