...
void OverviewPage::setBalance(qint64 balance, qint64 stake, qint64 unconfirmedBalance, qint64 immatureBalance)
{
    ...
    ui->labelBalance->setText(WayawolfcoinUnits::formatWithUnit(unit, balance));
    ui->labelStake->setText(WayawolfcoinUnits::formatWithUnit(unit, stake));
    ui->labelUnconfirmed->setText(WayawolfcoinUnits::formatWithUnit(unit, unconfirmedBalance));
    ui->labelImmature->setText(WayawolfcoinUnits::formatWithUnit(unit, immatureBalance));
    ui->labelTotal->setText(WayawolfcoinUnits::formatWithUnit(unit, balance + stake + unconfirmedBalance + immatureBalance));
